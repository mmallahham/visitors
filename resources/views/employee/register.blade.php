            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" 
                        ...
                        @else
                            action="{{route('employee.update',['id' => $id])}}">
                        @endif
                        @csrf
                        <div class="row">
                        <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="job-title" type="text" class="form-control" name="job-title" value="{{ $isNew ? old('job-title') : $visitor->visitees }}" required>
                            </div>
                        </div>                        
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dept" type="text" class="form-control" name="dept" value="{{ $isNew ? old('dept') : $visitor->purpose }}" required>
                            </div>
                        </div>
                        </div>
                        <div class="col-md-3">
